...
public class Jeroo extends JerooBase {
     ...
     */
    public void meander() {
      // ARONSON:  You are supposed to stop when there is
      //   a Net ahead, not a flower!
      // You can use isFlower(LEFT), isFlower(RIGHT) to
      // check to see if there is a flower on left or right
      while(!isNet(AHEAD)){
